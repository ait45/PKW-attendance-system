      ...
      <div className="bg-white rounded-lg shadow-lg p-4">
        ...
        <div className="flex flex-wrap gap-4 mb-4 items-end">
          ...
          <button
            ...
            className="bg-emerald-500 hover:bg-emerald-600 text-white px-4 py-2 rounded-lg shadow transition-colors flex items-center ml-auto"
          >
        ...
        <div className="flex justify-between items-center mt-4">
          ...
          <div className="flex gap-2">
            <button
              ...
              className="px-3 py-1 border rounded-md disabled:opacity-50 disabled:cursor-not-allowed hover:bg-slate-100"
            >
              ก่อนหน้า
            </button>
