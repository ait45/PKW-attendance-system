        ...
        <div className="flex items-center justify-between mb-4">
          ...
          {isTeacher && (
            <button
              ...
              className="bg-emerald-500 hover:bg-emerald-600 text-white px-2 sm:px-4 py-2 rounded-lg shadow transition-colors flex items-center"
            >
        ...
        <div className="flex gap-2 mb-4 flex-wrap">
          {["ทั้งหมด", "ปักหมุด", "ด่วน", "กิจกรรม", "ทั่วไป"].map((type) => (
            <button
              ...
              className={`px-3 py-1 rounded-full text-sm transition-colors ${filterType === type ? getTypeStatus(type) : "bg-slate-100 text-slate-400"}`}
            >
              {type}
            </button>
          ))}
              ...
              >
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <div className="flex items-center gap-1/2 sm:gap-2 mb-2 text-nowrap">
                    ...
                    <div className="flex items-center gap-1/2 sm:gap-2 text-xs text-slate-500">
                      ...
                      <span className="flex items-center">โดย: {notification.CREATED_BY}</span>
                    </div>
                  </div>
                ...
                <div>
                  ...
                  >
                    ...
                    <optgroup label="เฉพาะชั้นเรียน">
                      <option value="class:ม.1">มัธยมศึกษาปีที่ 1 เท่านั้น</option>
                      <option value="class:ม.2">มัธยมศึกษาปีที่ 2 เท่านั้น</option>
                      <option value="class:ม.3">มัธยมศึกษาปีที่ 3 เท่านั้น</option>
                      <option value="class:ม.4">มัธยมศึกษาปีที่ 4 เท่านั้น</option>
                      <option value="class:ม.5">มัธยมศึกษาปีที่ 5 เท่านั้น</option>
                      <option value="class:ม.6">มัธยมศึกษาปีที่ 6 เท่านั้น</option>
                    </optgroup>
                  </select>
                </div>
              </div>
