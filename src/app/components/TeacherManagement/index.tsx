...
function Teacher_Management() {
  ...
  const [data_teachers, setData_teachers] = useState<Partial<Teacher>>({});
  ...
  const [formData_teacher, setFormData_teacher] = useState<FormData>({
    teacherId: "",
    name: "",
    department: "",
    phone: "",
  ...
  const handleInputChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
    ...
    setFormData_teacher((prev) => ({ ...prev, [name]: value }));
